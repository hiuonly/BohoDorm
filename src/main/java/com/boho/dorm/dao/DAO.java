...
import com.boho.dorm.entity.QLusers;
import com.boho.dorm.entity.Room;
import com.boho.dorm.entity.RoomType;
import com.boho.dorm.entity.Roomdetail;
import com.boho.dorm.entity.ServiceType;
import com.boho.dorm.entity.Services;
...
public class DAO {
    ...
    public void AddCustomer(String urlimage, String cname, String birthofday, String cccd, String sdt, String gender, String caddress, String country, int usid) {
        String query = "INSERT INTO customer (urlimage, cname, birthofday, cccd, sdt, gender, caddress, country, usid) VALUES (?,?,?,?,?,?,?,?,?);";
        try {
            con = new DBConnect().connection;
            ps = con.prepareStatement(query);
